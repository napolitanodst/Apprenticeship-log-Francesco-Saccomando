...
i=0
distances_matrix <- matrix(NA, nrow = 1, ncol = ncol(matricione))
...
library(xlsx)
export <- (distances_matrix[1, ])
df <- as.data.frame(export)
write.xlsx(df, file = "distanze_export.xlsx", sheetName = "Foglio 1")

distanze_export <- read.xlsx("C:/Users/franc/Desktop/Glioblastoma/distanze_export.xlsx", sheetIndex = 1)
farmaci<- colnames(matricione)
distanze_export$Colonna4 <- farmaci
write.xlsx(distanze_export, file = "distanze_export.xlsx", sheetName = "Foglio 1")
